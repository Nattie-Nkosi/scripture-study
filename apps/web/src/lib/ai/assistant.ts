...
const SYSTEM_INSTRUCTIONS = [
  ...
  "For a definition, background, or topical cross-references — what a term means, who a person was, or where a subject appears — use the search_study_helps tool to consult the Bible Dictionary, Topical Guide, Index, and Joseph Smith Translation.",
  "Ground every answer in the provided passage and any results your tools return, and cite what you drew from — the book, chapter, and verse for scripture, and the entry title with its work (e.g. Bible Dictionary, \"Faith\") for study helps.",
